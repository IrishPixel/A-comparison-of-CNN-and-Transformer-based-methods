...
class GraphDataset(data.Dataset):
    ...
    def __init__(self, root, ids, target_patch_size=-1):
        ...
        self.classdict = {'normal': 0, 'luad': 1}       #
    ...
    def __getitem__(self, index):
        ...
        if site =='LUAD' or site =='LSCC':
            site = 'LUNG'
        #file_path = self.root + 'CPTAC_{}_features/simclr_files'.format(site)
        file_path = self.root + 'CPTAC_Merged_features/simclr_files/Merged'
        #_pre# with # rushin
        ...
        feature_path = os.path.join(file_path, 'features.pt')
        ...
        adj_s_path = os.path.join(file_path, 'adj_s.pt')
